...
public class ReachCheckpointEvent extends PlayerEvent implements Cancellable {
	...
	public ReachCheckpointEvent(Player player, JumpAndRun jumpAndRun, JumpAndRunPlayer jnrPlayer, int cp) {
		super(player);
